...
d <- read.table('/home/jessed/jessed/pgm_project/WordVectorsWithSemantics/results/to_plot/full_data_four_cols_with_weighted.csv', sep=',')
...
d$onto <- factor(d$V1, levels = c('PPDB','PPDB Weighted', 'WordNet', 'FrameNet', 'Union'))




pdf('plots_weighted_ppdb.pdf')
